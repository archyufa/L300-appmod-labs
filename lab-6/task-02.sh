...
GKE_CLUSTER_NAME="cepf-gke-cymbal-01-ap"
...
MEMBERSHIP_NAME="${GKE_CLUSTER_NAME}"
BINDING_NAME_1="${MEMBERSHIP_NAME}-${SCOPE_NAME_1}"
BINDING_NAME_2="${MEMBERSHIP_NAME}-${SCOPE_NAME_2}"
TEAM_EMAIL_1="student-02-a972c146ef94@qwiklabs.net"
TEAM_EMAIL_2="student-02-0431ee78f3cf@qwiklabs.net" 
ROLE_1="admin"
ROLE_2="edit"
...
echo "Task 2: Grant team members #1 access to the team scope #1 ..."
...
echo "Task 2: Grant team members #1 access to the team scope #2 ..."
...
# 2. Enable Policy Controller on the fleet membership
